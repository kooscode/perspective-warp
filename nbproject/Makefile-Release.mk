...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/perspective-warp: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/perspective-warp ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/_ext/e1dda48/vision_warp.o: ../libterraclear/src/vision_warp.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/e1dda48
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/e1dda48/vision_warp.o ../libterraclear/src/vision_warp.cpp
